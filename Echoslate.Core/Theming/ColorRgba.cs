...
public readonly struct ColorRgba(byte r, byte g, byte b, byte a = 255) {
	...
	public static readonly ColorRgba LightSuccessGreen = new(51, 229, 93);
	public static readonly ColorRgba SuccessGreen = new(40, 167, 69);
	public static readonly ColorRgba DarkSuccessGreen = new(21, 90, 37);
	public static readonly ColorRgba DisabledSuccessGreen = new(9, 39, 16);
	public static readonly ColorRgba LightDangerRed = new(255, 61, 69);
	public static readonly ColorRgba DangerRed = new(220, 53, 69);
	public static readonly ColorRgba DarkDangerRed = new(143, 34, 45);
	public static readonly ColorRgba DarkerDangerRed = new(66, 15, 20);
	...
	public static readonly ColorRgba AppBackground = new(77, 77, 77);
	...
	public static readonly ColorRgba DarkFadedAccent = new(24, 33, 37);
	...
	public static readonly ColorRgba TabActiveBackground = new(30, 31, 34);
	public static readonly ColorRgba TabInactiveBackground = new(14, 14, 21);
}